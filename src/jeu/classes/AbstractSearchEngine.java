...
//Abstract class pour les algorithmes de recherche
public class AbstractSearchEngine {
    ...
    public Dimension [] getPath() {
      ...
      System.out.println("max sdepyh" +maxDepth);
      return ret;
    }
    
        public Dimension [] getPathInLocation(Dimension loc) {
      Dimension [] ret = new Dimension[maxDepth];
      for (int i=0; i<maxDepth; i++) {
        ret[i] = searchPath[i];
      }
